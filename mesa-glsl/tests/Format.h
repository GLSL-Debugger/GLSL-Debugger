...
const char* DBG_POSITIONS[14] = {
	"DBG_RS_POSITION_UNSET", "DBG_RS_POSITION_ASSIGMENT",
	"DBG_RS_POSITION_FUNCTION_CALL", "DBG_RS_POSITION_UNARY",
	"DBG_RS_POSITION_SELECTION_IF", "DBG_RS_POSITION_SELECTION_IF_ELSE",
	"DBG_RS_POSITION_SELECTION_IF_CHOOSE", "DBG_RS_POSITION_SELECTION_IF_ELSE_CHOOSE",
	"DBG_RS_POSITION_BRANCH", "DBG_RS_POSITION_LOOP_FOR",
	"DBG_RS_POSITION_LOOP_WHILE", "DBG_RS_POSITION_LOOP_DO",
	"DBG_RS_POSITION_LOOP_CHOOSE", "DBG_RS_POSITION_DUMMY"
};
